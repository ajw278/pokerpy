...
#  \version 1.0.3
#
#  EDITS - Andrew 05/03/2016: Added lines to make buttons transparent
#
...
class cMenu:
   ...
   def __init__(self, x, y, h_pad, v_pad, orientation, number, background,
                buttonList, buttonColour, fontsize, offset = (0,0)):
      ## menu items
      self.menu_items = []                      # List of menu items
      self.font = pygame.font.Font('./Fonts/Alien_League.ttf', fontsize)    # Font to use
      ...
      self.u_color = DARKERGREEN                      # Color for unselected text
   ...
   def set_button_images(self):
      for button in self.menu_items:
         ...
         if button['b_image'] == None:
            ...
            selected_image.fill(self.b_colour)
            ...
            unselected_image.fill(self.b_colour)
